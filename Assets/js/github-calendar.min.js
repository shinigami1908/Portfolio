  ...
  return function n(a, o, u) {
    function s(t, e) {
      ...
      var p = e("github-calendar-parser"),
        ...
        d = b(d), (f = f || {}).summary_text = f.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", f.cache = 1e3 * (f.cache || 86400), !1 === f.global_stats;var r = { content: "gh_calendar_content." + e, expire_at: "gh_calendar_expire." + e };return f.proxy = f.proxy || function (e) {
